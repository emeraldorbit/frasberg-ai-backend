 ...
 */
export function generateIntent(evaluation) {
    if (evaluation > 0.5)
        return { intent: 'advance', weight: evaluation };
    if (evaluation < -0.5)
        return { intent: 'retreat', weight: Math.abs(evaluation) };
    return { intent: 'hold', weight: Math.abs(evaluation) };
}
//# sourceMappingURL=field_intent.js.map